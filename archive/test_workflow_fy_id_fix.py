...
def test_workflow_fy_id_handling():
    ...
    try:
        ...
        for case in cases:
            ...
            print(f"  {transaction_no}: {list_name}, {status}, fy_id={fy_id} [{fy_status}]")
        ...
        if test_case:
            ...
            print(f"Testing workflow transition for case: {transaction_no} ({list_name}, {status})")
            ...
            if copied_case:
                copied_transaction_no, copied_list, copied_status, copied_fy_id = copied_case
                print(f"Copied case created: {copied_transaction_no} ({copied_list}, {copied_status}, fy_id={copied_fy_id})")

                if copied_fy_id == current_fy_id:
                    print("PASS: Copied case has correct fy_id")
                else:
                    print(f"FAIL: Copied case has invalid fy_id {copied_fy_id} (should be {current_fy_id})")
                    return False
            else:
