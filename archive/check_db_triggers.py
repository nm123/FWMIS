    ...
    try:
        ...
        if orphaned_periods > 0:
            ...
            for period in orphaned_period_details:
                print(f"  Period ID: {period[0]}, FY_ID: {period[1]}, Period: {period[2]}, Status: {period[3]}")
        ...
        if fy149_periods > 0:
            ...
            for period in fy149_period_details:
                print(f"  Period ID: {period[0]}, Period: {period[1]}, Status: {period[2]}")
        ...
        if case_202600023:
            ...
            cursor.execute("SELECT start_year, end_year FROM financial_years WHERE id = ?", (fy_id,))
