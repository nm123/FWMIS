...
# Delete FY 149 if exists (no op)
cur.execute('DELETE FROM financial_years WHERE id=149')

# Update FY 7 to 2025-2026
cur.execute('''
    UPDATE financial_years 
    SET start_year=2025, end_year=2026, status='open'
    WHERE id=7
''')

# Migrate cases from 149 to 7 (no op if none)
