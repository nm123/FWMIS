...
from scripts.Utilities.optimization_manager import (
    get_optimization_manager, get_optimization_summary
)
    ...
    def refresh_performance_status(self):
        ...
        try:
            ...
            for key, checkbox in self.optimization_checkboxes.items():
                ...
                status_text += f"{status_icon} {self.optimization_checkboxes[key].text()}\n"
    ...
    def accept(self):
        ...
        try:
            ...
            QMessageBox.critical(
                self,
                "Error",
                f"Failed to apply optimization settings:\n\n{str(e)}"
            )
