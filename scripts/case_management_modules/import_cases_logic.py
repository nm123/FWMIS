...
from scripts.Utilities.import_worker_utils import import_cases, perform_import, update_progress, import_finished, import_error
...
class ImportCasesLogic:
    ...
    def parse_file(self):
        ...
        try:
            ...
            transactions, extracted_date_from, extracted_date_to = parse_bas_file(self.dialog.bas_file_path)
            ...
            QMessageBox.critical(self.dialog, "Parse Error", f"Failed to parse BAS file:\n{str(e)}")
