...
class EditCaseDialog(QDialog):
    ...
    def load_case_data(self):
        ...
        if len(self.case_data) > 17 and self.case_data[17] and os.path.exists(self.case_data[17]):  # minutes at 17
            self.minutes_edit.setText(self.case_data[17])
        elif len(self.case_data) > 17 and self.case_data[17]:
            print(f"Warning: Minutes file not found: {self.case_data[17]}")
        ...
        # Set Loss Control fields - use status instead of recommendation
        if len(self.case_data) > 17 and self.case_data[17]:  # loss_control_status (now at index 17)
            self.loss_control_status_combo.setCurrentText(self.case_data[17])
    ...
    def save_case(self):
        try:
            ...
            try:
                ...
                # Handle Loss Control Recommendation changes - removed as per user request
