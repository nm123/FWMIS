...
class OptimizedBASParser:
    ...
    def parse_file_streaming(
        self, file_path: str, date_from=None, date_to=None
    ) -> Iterator[List[Dict]]:
            ...
            with open(file_path, "r", encoding="utf-8") as file:
                for line_num, line in enumerate(file, 1):
                    ...
                    transaction = self._process_line(
                        line, current_responsibility, current_item, date_from, date_to
                    )
                    ...
                    current_responsibility, current_item = self._update_context(
                        line, current_responsibility, current_item
                    )
    ...
    def _update_context(
        self, line: str, current_responsibility: str, current_item: str
    ) -> tuple:
            ...
            with memory_efficient_db_connection() as conn:
                ...
                for i in range(0, len(cases), self.batch_size):
                    ...
                    try:
                        ...
                        logger.info(
                            f"Successfully inserted batch of {len(batch)} cases"
                        )
