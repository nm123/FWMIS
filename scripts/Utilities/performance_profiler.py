...
def profile_operation(
    operation_name: str, profiler: Optional[PerformanceProfiler] = None
):
...
class MemoryProfiler:
    ...
    def log_memory_usage(self):
        ...
        try:
            ...
            logger.info(
                f"Process Memory: RSS={process_memory.rss / 1024 / 1024:.1f}MB, VMS={process_memory.vms / 1024 / 1024:.1f}MB"
            )
            ...
            def wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    if duration > 1.0:  # Queries taking more than 1 second
                        ...
                        logger.warning(
                            f"Slow query detected: {duration:.3f}s - {query_key}"
                        )
...
def create_performance_report() -> str:
    ...
    try:
        ...
        report.append(
            f"  Available Memory: {memory.available / 1024 / 1024 / 1024:.1f} GB"
        )
