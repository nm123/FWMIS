...
class AddNewCaseDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.criminal_charges_combo.addItems(["No", "Yes", "Unknown"])
        self.criminal_charges_combo.setCurrentText("No")
        form_layout.addRow("Criminal Charges:", self.criminal_charges_combo)
        ...
        form_layout.addRow("Supporting Evidence:", file_layout)
    ...
    def on_status_changed(self, status):
        ...
        if status == "Valid":
            ...
            if reply == QMessageBox.Yes:
                ...
                self.file_path_edit.setPlaceholderText("Supporting Evidence is REQUIRED - Select file...")
            else:
