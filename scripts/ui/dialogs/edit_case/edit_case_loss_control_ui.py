...
def setup_loss_control_ui_components(dialog_instance):
    ...
    dialog_instance.lc_status_combo.addItems(["Awaiting LC determination", "Recovered", "Write Off Recommended"])
    ...
    dialog_instance.recovery_evidence_button.clicked.connect(dialog_instance.browse_recovery_evidence)
    dialog_instance.recovery_evidence_view_button = QPushButton("View")
    dialog_instance.recovery_evidence_view_button.clicked.connect(dialog_instance.view_recovery_evidence)
    ...
    loss_control_layout.addRow(dialog_instance.recovery_evidence_label, recovery_evidence_layout)
