...
"""
from PyQt5.QtWidgets import QGroupBox, QFormLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QTextEdit
...
def setup_supporting_ui_components(dialog_instance):
    ...
    supporting_layout.addRow(dialog_instance.bas_label, dialog_instance.bas_payment_no_edit)
    ...
    dialog_instance.bas_payment_date_button.clicked.connect(dialog_instance.select_bas_payment_date)
    ...
    supporting_layout.addRow(dialog_instance.bas_journal_label, dialog_instance.bas_journal_no_edit)
    ...
    dialog_instance.bas_journal_date_button.clicked.connect(dialog_instance.select_bas_journal_date)
    ...
    supporting_layout.addRow(dialog_instance.bas_journal_date_label, bas_journal_date_layout)

    # Persal No field
    dialog_instance.persal_label = QLabel("Persal No:")
    dialog_instance.persal_no_edit = QLineEdit()
    supporting_layout.addRow(dialog_instance.persal_label, dialog_instance.persal_no_edit)
    ...
    dialog_instance.supporting_evidence_button.clicked.connect(dialog_instance.browse_supporting_evidence)
    dialog_instance.supporting_evidence_view_button = QPushButton("View")
    dialog_instance.supporting_evidence_view_button.clicked.connect(dialog_instance.view_supporting_evidence)
    ...
    supporting_evidence_layout.addWidget(dialog_instance.supporting_evidence_view_button)
    ...
    supporting_layout.addRow(dialog_instance.supporting_evidence_label, supporting_evidence_layout)
    ...
    additional_layout.addRow("Criminal Charges Laid:", dialog_instance.criminal_charges_combo)
    ...
    additional_layout.addRow("Disciplinary process in progress or completed:", dialog_instance.disciplinary_combo)
    ...
    additional_layout.addRow("Loss recovery commenced or completed:", dialog_instance.loss_recovery_combo)
    ...
    additional_layout.addRow("Steps taken to prevent future occurrence of F&W expenditure:", dialog_instance.prevention_steps_edit)
