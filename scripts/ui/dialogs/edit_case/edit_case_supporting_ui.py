...
def setup_supporting_ui_components(dialog_instance):
    ...
    additional_layout.addRow("Disciplinary Charges:", dialog_instance.disciplinary_combo)
    ...
    recovery_evidence_layout.addWidget(dialog_instance.recovery_evidence_rip_view_button)
