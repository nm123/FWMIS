...
try:
    ...
    from .case_management_modules.add_case import (AddNewCaseDialog,
                                                   AssessmentDialog)
    ...
    from .case_management_modules.view_cases import (CaseDetailsDialog,
                                                     ViewCasesDialog)
    from .ui.dialogs.import_cases_dialog import import_undisclosed_cases
    # Import from new modular structure
    from .ui.dialogs.import_cases_dialog_core import \
        ImportUndisclosedCasesDialog
except ImportError:
    # Fall back to absolute imports (when run directly)
    from scripts.case_management_modules.add_case import (AddNewCaseDialog,
                                                          AssessmentDialog)
    from scripts.case_management_modules.deleted_cases import \
        ViewDeletedCasesDialog
    from scripts.case_management_modules.edit_cases_dialog import \
        EditCasesDialog
    ...
    from scripts.case_management_modules.view_cases import (CaseDetailsDialog,
                                                            ViewCasesDialog)
